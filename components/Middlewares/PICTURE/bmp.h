...
typedef void (*lcd_bmp_write_cb)(uint16_t w,uint16_t h,uint8_t *video_buf);

/* 函数声明 */
uint8_t bmp_decode(const char *filename, int width, int height,lcd_bmp_write_cb lcd_cd);                                            /* BMP解码 */
