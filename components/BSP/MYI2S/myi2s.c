...
static bool i2s_trx_enabled = false; /* I2S TRX启用状态 */
...
esp_err_t myi2s_init(void)
{
    ...
    i2s_std_config_t std_cfg = {
        ...
        .slot_cfg = {
            ...
            .ws_pol = false,                            /* WS信号极性 */
            .bit_shift = true,                          /* Philips 标准 I2S 格式 */
            .left_align = false,                        /* Philips: 非左对齐, 数据延迟1个BCLK */
    ...
    i2s_trx_enabled = true; /* 编解码器驱动在esp_codec_dev_open中会启用通道 */
